...
def test_factory_model_save_load_roundtrip(
    tmp_path, factory_cls, output_head, output_dim
):
    """Factory-built models should survive save/load roundtrips for both output heads."""
    from qgravnet import factory as factory_module
    ...
    save_path = tmp_path / f"{factory_cls}_{output_head}.keras"
    model.save(save_path)
